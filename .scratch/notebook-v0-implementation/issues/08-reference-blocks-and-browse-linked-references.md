...
**Blocked by:** 03 — Edit nested journal outlines; 07 — Author and follow durable Page Links; [Define link resolution and linked references](../../notebook-v0/issues/11-define-link-resolution-and-linked-references.md)
