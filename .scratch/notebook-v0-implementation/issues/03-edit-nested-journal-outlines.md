...
- [x] A Block has at most one Containment parent, and invalid structural moves are rejected without partial mutation.
- [x] Moving or editing a Block preserves its stable identity.
- [x] Leaf deletion is permanent, parents with children are protected, and restoration is reserved for ticket 04 undo history.
