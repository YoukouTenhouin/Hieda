...
Page rename is not added to the existing per-Page outline undo history. Instead, the same Page Link
rewrite is applied to matching Authored Text in all affected session-local undo and redo snapshots,
