...
The Linux toolchain and initial TGZ decision remain in force. Cross-platform compiler support and
dependency acquisition are superseded by [ADR 0005](0005-cross-platform-application-support.md).
